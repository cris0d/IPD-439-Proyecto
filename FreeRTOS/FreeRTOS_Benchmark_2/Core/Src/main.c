...
void StartTastkA(void *argument);
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of TaskA */
  TaskAHandle = osThreadNew(StartTastkA, NULL, &TaskA_attributes);
...
/* USER CODE BEGIN Header_StartTastkA */
/**
  * @brief  Function implementing the TaskA thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartTastkA */
void StartTastkA(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
